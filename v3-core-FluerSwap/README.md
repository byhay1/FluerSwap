...
`@byhay1/v3-core-FluerSwap`
and import the factory bytecode located at
`@byhay1/v3-core/artifacts/contracts/UniswapV3Factory.sol/UniswapV3Factory.json`.
For example:
...
mainnet and public testnets, and all FluerSwap code will correctly interoperate with
